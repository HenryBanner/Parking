...
//    lb1->setScaledContents(true);
    ...
    QMovie *m = new QMovie(":/images/1.gif");
    m->start();
    lb_gif->setMovie(m);

    QLabel *lb_gif1 = new QLabel();  //主页动图车
    lb_gif1->setScaledContents(true);
    QMovie *m1 = new QMovie(":/images/10.gif");
    m1->start();
    lb_gif1->setMovie(m1);
    ...
    QMovie *m2 = new QMovie(":/images/2.gif");
    m2->start();
    lb_gif2->setMovie(m2);
    ...
    QMovie *m3 = new QMovie(":/images/7.gif");
    m3->start();
    lb_gif3->setMovie(m3);
    ...
    QMovie *m4 = new QMovie(":/images/9.gif");
    m4->start();
    lb_gif4->setMovie(m4);
